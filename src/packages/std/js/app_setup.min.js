...
function loadURL(a) {
    $("#dfxScreenUrl").val(a), $("#dfxScreenUrl").trigger("change")
}
function drawBreadCrumb() {
    var a = $("nav li.active > a"), b = a.length;
    null != $.bread_crumb && ($.bread_crumb.empty(), $.bread_crumb.append($("<li>Home</li>")), a.each(function () {
...
$.navAsAjax = !0, $.enableJarvisWidgets = !0, angular.element(document).ready(function () {
    $.root_ = $("body"), $.left_panel = $("#left-panel"), $.shortcut_dropdown = $("#shortcut"), $.bread_crumb = $("#ribbon ol.breadcrumb"), $.intervalArr = new Array;
    var a = !1;
    $.device = null;
    var b = /iphone|ipad|ipod|android|blackberry|mini|windows\sce|palm/i.test(navigator.userAgent.toLowerCase());
    b ? ($.root_.addClass("mobile-detected"), $.device = "mobile", $.fastClick && ($.root_.addClass("needsclick"), FastClick.attach(document.body))) : ($.root_.addClass("desktop-detected"), $.device = "desktop"), ($("body").hasClass("menu-on-top") || "top" == localStorage.getItem("sm-setmenu")) && (a = !0, $("body").addClass("menu-on-top")), $("#main_menu").size() > 0 && DreamFace.getMenu("main", function (b) {
        for (var d = 0; d < b.definition.length; d++)c(b.definition[d], "main_menu");
        a || $("nav ul").jarvismenu({
            accordion:  !0,
            speed:      $.menu_speed,
    ...
    var c = function (a, b) {
        var d = Math.floor(1e5 * Math.random()), e = '<li id="' + d + '"';
        if (a.children.length > 0) {
            e += '><a href="#"><i class="' + a.icon_class + '"></i> <span class="menu-item-parent">' + a.label + '</span></a><ul id="' + d + '_submenu"></ul></li>', $("#" + b).append(e);
            for (var f = 0; f < a.children.length; f++)c(a.children[f], d + "_submenu")
        } else e += ' data-menu-ref="' + a.action + '"><a href="' + a.action + '" title="' + a.label + '"><i class="' + a.icon_class + '"></i> <span' + ("main_menu" == b ? ' class="menu-item-parent"' : "") + ">" + a.label + "</span></a></li>", $("#" + b).append(e)
    }, d = {
    ...
    $.root_.on("click", '[data-action="userLogout"]', function (a) {
        ...
        $(this).prop("checked") ? (localStorage.setItem("sm-setmenu", "top"), window.location.href = "index.html") : (localStorage.setItem("sm-setmenu", "left"), window.location.href = "index.html")
    ...
    var e = $("#datatable_fixed_column").DataTable({sDom: "<'dt-toolbar'<'col-xs-6'f><'col-xs-6'<'toolbar'>>r>t<'dt-toolbar-footer'<'col-xs-6'i><'col-xs-6'p>>"});
    $("#datatable_fixed_column thead th input[type=text]").on("keyup change", function () {
        e.column($(this).parent().index() + ":visible").search(this.value).draw()
    }), $("#datatable_col_reorder").dataTable({sDom: "<'dt-toolbar'<'col-xs-6'f><'col-xs-6'C>r>t<'dt-toolbar-footer'<'col-xs-6'i><'col-xs-6'p>>"}), $("#datatable_tabletools").dataTable({
        ...
        oTableTools: {
            aButtons: ["copy", "csv", "xls", {
                ...
                sPdfSize:    "letter"
            }, {sExtends: "print", sMessage: "Generated by SmartAdmin <i>(press Esc to close)</i>"}],
