...
$.navAsAjax = !0,
    ...
    b ? ($.root_.addClass("mobile-detected"), $.device = "mobile", $.fastClick && ($.root_.addClass("needsclick"), FastClick.attach(document.body))) : ($.root_.addClass("desktop-detected"), $.device = "desktop"), ($("body").hasClass("menu-on-top") || "top" == localStorage.getItem("sm-setmenu")) && (a = !0, $("body").addClass("menu-on-top")), $("#main_menu").size() > 0 && DreamFace.getMenu("main", function (b) {
        for (var d = 0; d < b.definition.length; d++)
            c(b.definition[d], "main_menu");
        //a || $("nav ul").jarvismenu({
        //    accordion:  !0,
        //    speed:      $.menu_speed,
    ...
    var c = function (a, b) {
        var d = Math.floor(1e5 * Math.random()), e = '';
         e += '<a class="tab-item" id="' + d + '" href="' + a.action + '" title="' +
         a.label + '" data-menu-ref="' + a.action +
         '"><span class="' + a.icon_class +
         '"></span> <span' + ("main_menu" == b ? ' class="menu-item-parent tab-label"' : 'class="tab-label"') + ">" +
         a.label + "</span></a>", $("#" + b).append(e)
    }, d = {
