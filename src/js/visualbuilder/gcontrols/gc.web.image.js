...
var gc_web_image = {
    ...
    "createDefinition": function( component_id, container_id ) {
        var default_attributes = gc_factory.getDefaultAttributes( gc_web_image.attributeDefinition );
        return {
            id: component_id,
            type: "image",
    ...
    "renderDesign": function( component ) {
        ...
        if (!component.attributes) {
            attributes = gc_factory.getDefaultAttributes( gc_web_image.attributeDefinition );
        } else {
            attributes = gc_factory.migrateAttributes( gc_web_image.attributeDefinition, component.attributes );
        }
        ...
        fragment_html = '<div id="' + component.id + '"  gc-role="control" gc-type="image" ' +
            ...
            'class="' + gc_web_image.default_classes + (attributes.containerClasses.value != '' ? ' '+attributes.containerClasses.value : '') + '">';
    ...
    "loadPropertyPanel": function(gc_component_definition) {
        ...
        gc_factory.generatePropertyPanel( gc_web_image.attributeDefinition, gc_component_definition );
    ...
    "savePropertyPanel": function() {
        ...
        var attributes = gc_factory.getPropertiesFromPanel( gc_web_image.attributeDefinition );
