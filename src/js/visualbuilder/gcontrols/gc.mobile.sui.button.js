...
var gc_mobile_button = {
    ...
    "renderDesign": function( component ) {
        ...
        if (attributes.icon.value != '' && attributes.iconPosition.value == 'right') {
        ...
        var add_label = (attributes.icon.value)
            ? (attributes.iconPosition.value =='right')
                ? '<i class="'+attributes.icon.value+' right icon"></i><span>'+attributes.label.value+'</span>'
    ...
    "savePropertyPanel": function() {
        ...
        if(attributes.icon.value != ''){
            el.text('');
            if (attributes.iconPosition.value =='right') {
                el.append('<i class="' + attributes.icon.value + ' right icon"></i><span>' + attributes.label.value + '</span>');
            } else {
