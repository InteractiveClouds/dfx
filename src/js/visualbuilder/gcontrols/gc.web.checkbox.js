...
var gc_web_checkbox = {
    ...
    "createDefinition": function( component_id, container_id ) {
        var default_attributes = gc_factory.getDefaultAttributes( gc_web_checkbox.attributeDefinition );
        return {
            id: component_id,
            type: "checkbox",
    ...
    "renderDesign": function( component ) {
        ...
        if (!component.attributes) {
            attributes = gc_factory.getDefaultAttributes( gc_web_checkbox.attributeDefinition );
        } else {
            attributes = gc_factory.migrateAttributes( gc_web_checkbox.attributeDefinition, component.attributes );
        }
        ...
        var fragment_html = '<div id="' + component.id + '" gc-role="control" gc-type="checkbox" ' +
            ...
            'class="' + gc_web_checkbox.default_classes + (attributes.containerClasses.value != '' ? ' ' + attributes.containerClasses.value : '') + '">';
    ...
    "loadPropertyPanel": function(gc_component_definition) {
        ...
        gc_factory.generatePropertyPanel( gc_web_checkbox.attributeDefinition, gc_component_definition );
    ...
    "savePropertyPanel": function() {
        ...
        var attributes = gc_factory.getPropertiesFromPanel( gc_web_checkbox.attributeDefinition );
        ...
        $('#'+id).attr( {
            'class': gc_web_checkbox.default_classes + ' ' + attributes.containerClasses.value,
            'style': 'display:inline-block;position:relative;' + attributes.containerStyle.value + ';' + containerCss
        });
