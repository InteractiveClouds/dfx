...
/* GC Web Layout Column */

var gc_web_layout_column = {
    "label": "Layout Column",
    "category": "default",
    "subcontrol": true,
    "renderDesign": function( component_attributes, container_id, index_row, index_child, index_layout ) {
        ...
        var fragment_html = '<div id="' + container_id + '_layout_'+index_layout+'_row_'+index_row+'_column_'+index_child+'"  gc-control-id="'+container_id + '" gc-parent="'+container_id + '" gc-role="control-child" gc-type="layout-column" gc-container="layout_'+index_layout+'_row_'+index_row+'_column_'+index_child+'" gc-layout-index="'+index_layout+'" gc-row-index="'+index_row+'" gc-child-index="'+index_child+'" class="'
            + 'dfx_visual_editor_gc_layout_col col-md-' + component_attributes.width.value + ' dfx_visual_editor_draggable dfx_visual_editor_gc_draggable dfx_visual_editor_droppable '
    ...
    "savePropertyPanel": function() {
        ...
        el.attr({
            'class': 'dfx_visual_editor_gc_layout_col col-md-'+width+' dfx_visual_editor_draggable dfx_visual_editor_gc_draggable dfx_visual_editor_droppable '+classes,
