...
var gc_web_combobox = {
        ...
        "categories": [
            ...
            {"id": "component_props",
                ...
                "properties": [
                    ...
                    { "id": "css", "type": "css", "propType": "input-css", "default": {"width": "200px"}, "cssOptions": [ "width", "height", "color", "background", "padding", "margin", "text-align" ] },
    ...
    "createDefinition": function( component_id, container_id ) {
        var default_attributes = gc_factory.getDefaultAttributes( gc_web_combobox.attributeDefinition );
    ...
    "renderDesign": function( component ) {
        ...
        if (!component.attributes) {
            attributes = gc_factory.getDefaultAttributes( gc_web_combobox.attributeDefinition );
        } else {
            attributes = gc_factory.migrateAttributes( gc_web_combobox.attributeDefinition, component.attributes );
        }
        ...
        var fragment_html;
        fragment_html = '<div id="' + component.id + '"  gc-role="control" gc-type="combobox" ' +
            'style="display:inline-block;position:relative;' + attributes.containerStyle.value  + ';' + containerCss + '" ' +
            'class="' + gc_web_combobox.default_classes + (attributes.containerClasses.value != '' ? ' '+attributes.containerClasses.value : '') + '">';
        ...
        fragment_html += '<div id="' + component.id + '_form_group" ' +
            ...
            '<select id="' + component.id + '_field" class="form-control ' + ((attributes.classes.value != '') ? attributes.classes.value : '') + '" ' +
    ...
    "loadPropertyPanel": function(gc_component_definition) {
        ...
        gc_factory.generatePropertyPanel( gc_web_combobox.attributeDefinition, gc_component_definition );
    ...
    "savePropertyPanel": function() {
        ...
        var attributes = gc_factory.getPropertiesFromPanel( gc_web_combobox.attributeDefinition );
        ...
        $('#'+id).attr( {
            'class': gc_web_combobox.default_classes + ' ' + attributes.containerClasses,
