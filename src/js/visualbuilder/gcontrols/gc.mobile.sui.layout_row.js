...
var gc_mobile_layout_row = {
    ...
    "renderDesign": function( component_attributes, container_id, index_child, layout_index_child ) {
        ...
        for (i=0; i<component_attributes.cols.length; i++) {
            fragment_html += gc_mobile_layout_column.renderDesign(component_attributes.cols[i], container_id, index_child, i, layout_index_child);
        }
    ...
    "loadPropertyPanel": function(gc_component_definition, gc_control_child_id) {
        ...
        fragment_html += '</div>';
        fragment_html += '</div>';
        fragment_html += '<div class="row"><div class="sixteen wide column"><a id="layout_manager_add_column" href="javascript:void(0);" container-id="'+gc_component_definition.id+'" row-index="'+row_index+'"><span class="fa fa-plus-circle" style="margin-right: 5px"></span>Add Column</a></div></div>';
        ...
        $('#layout_manager_add_column').click( function() {
            ...
            gc_mobile_layout_row.addColumn(container_id, row_index);
        });
    ...
    "savePropertyPanel": function() {
        ...
        el.attr({'class': classes, 'style': style + ';min-height:30px;height:auto;margin:0;' + rowCss});
