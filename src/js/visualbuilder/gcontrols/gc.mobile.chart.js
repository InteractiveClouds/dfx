...
var gc_mobile_chart = {
        ...
        "categories": [
            ...
            {"id": "component_props",
                ...
                "properties": [
                    ...
                    { "id": "css", "type": "css", "propType": "input-css", "default": {"width": "100%", "height": "200px"}, "cssOptions": [ "width", "height" ] },
    ...
    "createDefinition": function( component_id, container_id ) {
        var default_attributes = gc_factory.getDefaultAttributes( gc_mobile_chart.attributeDefinition );
        return {
            id: component_id,
            type: "chart",
    ...
    "renderDesign": function( component, already_dropped ) {
        ...
        if (!component.attributes) {
            attributes = gc_factory.getDefaultAttributes( gc_mobile_chart.attributeDefinition );
        } else {
            attributes = gc_factory.migrateAttributes( gc_mobile_chart.attributeDefinition, component.attributes );
        }
        ...
        var fragment_html = '<div id="' + instance_id + '"  gc-role="control" gc-type="chart" '
            ...
            + 'class="' + gc_mobile_chart.default_classes + (attributes.containerClasses.value != '' ? ' '+attributes.containerClasses.value : '') + '" '
    ...
    "loadPropertyPanel": function(gc_component_definition) {
        ...
        gc_factory.generatePropertyPanel( gc_mobile_chart.attributeDefinition, gc_component_definition );
    ...
    "savePropertyPanel": function() {
        ...
        var attributes = gc_factory.getPropertiesFromPanel( gc_mobile_chart.attributeDefinition );
        ...
        el.attr( {
            'class': gc_mobile_chart.default_classes + ' ' + attributes.containerClasses.value,
            //'style': 'display:inline-block;position:relative;' + attributes.containerStyle.value + ';' + containerCss
            'style': 'position:relative;' + attributes.containerStyle.value + ';' + containerCss
        });
