...
/* GC Web Checkbox Toggle */
var gc_web_checkbox_toggle = {
    ...
    "createDefinition": function( component_id, container_id ) {
        var default_attributes = gc_factory.getDefaultAttributes( gc_web_checkbox_toggle.attributeDefinition );
        return {
            id: component_id,
            type: "checkboxtoggle",
    ...
    "renderDesign": function( component, gc_already_dropped ) {
        ...
        if (!component.attributes) {
            attributes = gc_factory.getDefaultAttributes( gc_web_checkbox_toggle.attributeDefinition );
        } else {
            attributes = gc_factory.migrateAttributes( gc_web_checkbox_toggle.attributeDefinition, component.attributes );
        }
        ...
        if (gc_already_dropped) {
            setTimeout('gc_web_checkbox_toggle.setSwitch('+instance_id+', \'' + size + '\', \'' + onLabel + '\', \'' + offLabel + '\', \'' + onColor + '\', \'' + offColor + '\', \'' + centralLabel + '\', \'' + centralIcon + '\', \'' +
                gc_web_checkbox_toggle._private.parseSize(centralWidth) + '\', \'' + gc_web_checkbox_toggle._private.parseSize(handleWidth) + '\')', 20);
        }
        ...
        var fragment_html = '<div id="' + component.id + '" gc-role="control" gc-type="checkboxtoggle" ' +
            ...
            'class="' + gc_web_checkbox_toggle.default_classes + (attributes.containerClasses.value != '' ? ' ' + attributes.containerClasses.value : '') + '">';
        ...
        var component_instance = {
            ...
            "callback": function(comp_inst) {
                if (! gc_already_dropped) {
                    setTimeout(gc_web_checkbox_toggle.setSwitch(comp_inst.id, size, onLabel, offLabel, onColor, offColor, centralLabel, centralIcon,
                            gc_web_checkbox_toggle._private.parseSize(centralWidth), gc_web_checkbox_toggle._private.parseSize(handleWidth)), 20);
                }
            }
        };
    ...
    "loadPropertyPanel": function(gc_component_definition) {
        ...
        gc_factory.generatePropertyPanel( gc_web_checkbox_toggle.attributeDefinition, gc_component_definition );
    ...
    "savePropertyPanel": function() {
        ...
        var attributes = gc_factory.getPropertiesFromPanel( gc_web_checkbox_toggle.attributeDefinition );
        ...
        $('#'+id).attr( {
            'class': gc_web_checkbox_toggle.default_classes + ' ' + attributes.containerClasses.value,
            'style': 'display:inline-block;position:relative;' + attributes.containerStyle.value + ';' + containerCss
        });
