...
var gc_web_statictext = {
    ...
    "renderDesign": function( component ) {
        ...
        fragment_html = '<div id="' + component.id + '"  gc-role="control" gc-type="statictext" ' +
            'style="display:inline-block;position:relative;' + (component.attributes.containerStyle ? component.attributes.containerStyle.value : '') + ';' + containerCss + '" ' +
            'class="' + gc_web_statictext.default_classes + (component.attributes.containerClasses.value != "" ? ' '+component.attributes.containerClasses.value : '') + '">';
        ...
        fragment_html += '<div id="' + component.id + '_text" ' +
            'style="display:inline-block;' + (component.attributes.style ? component.attributes.style.value : '') + ';' + css + '" ' +
    ...
    "savePropertyPanel": function() {
        ...
        $('#'+id).attr( {
            'class': gc_web_statictext.default_classes + ' ' + containerClasses,
            'style': 'display:inline-block;position:relative;' + containerStyle + ';' + containerCss
        });

        $('#'+id+'_text').attr( {
            'class': classes,
            'style': 'display:inline-block;' + style + ';' + css
        });
