...
var gc_mobile_panel = {
    ...
    "renderDesign": function( component ) {
        ...
        var instance_id = component.id,
            ...
            fragment_html = '<div id="' + instance_id + '" class="content ' + attr.classes.value + '" style="' + panelCss + '" gc-role="control" gc-type="panel">';

        fragment_html += '<div id="' + instance_id + '_body" class="' + attr.bodyClasses.value + '" style="' + bodyCss + '">';
    ...
    "savePropertyPanel": function() {
        ...
        el.attr({ 'class': 'content ' + classes, 'style': panelCss });
