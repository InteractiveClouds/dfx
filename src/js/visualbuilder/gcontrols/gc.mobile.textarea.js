...
var gc_mobile_textarea = {
    ...
    "createDefinition": function( component_id, container_id ) {
        var default_attributes = gc_factory.getDefaultAttributes( gc_mobile_textarea.attributeDefinition );
    ...
    "renderDesign": function( component ) {
        ...
        if (!component.attributes) {
            attributes = gc_factory.getDefaultAttributes( gc_mobile_textarea.attributeDefinition );
        } else {
            attributes = gc_factory.migrateAttributes( gc_mobile_textarea.attributeDefinition, component.attributes );
        }
        ...
        fragment_html = '<div id="' + component.id + '"  gc-role="control" gc-type="textarea" ' +
            ...
            'class="' + gc_mobile_textarea.default_classes + (attributes.containerClasses.value != '' ? ' '+attributes.containerClasses.value : '') + '">';
    ...
    "loadPropertyPanel": function(gc_component_definition) {
        ...
        gc_factory.generatePropertyPanel( gc_mobile_textarea.attributeDefinition, gc_component_definition );
    ...
    "savePropertyPanel": function() {
        ...
        var attributes = gc_factory.getPropertiesFromPanel( gc_mobile_textarea.attributeDefinition );
        ...
        $('#'+id).attr( {
            'class': gc_mobile_textarea.default_classes + ' ' + attributes.containerClasses,
