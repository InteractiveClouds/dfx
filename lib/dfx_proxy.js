...
var initialize = function(app) {
    ...
    if ( SETTINGS.studio ) {
        ...
        app.get('/studio/gctemplates/type/:gcTemplateType/:applicationName', gate.studio, gc_templates.getByType);
        //app.get('/studio/gctemplates/list/:applicationName', gate.studio, gc_templates.list);
        //app.get('/studio/gctemplates/item/:screenTemplateName/:applicationName', gate.studio, gc_templates.select);
