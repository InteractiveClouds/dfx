...
var gc_templates = require('./dfx_gc_templates');
...
if ( SETTINGS.studio ) {
    ...
    var environments = require('./dfx_environments');
    var environment_variables = require('./dfx_environment_variables');
}
...
var initialize = function(app) {
    ...
    if ( SETTINGS.studio ) {
        ...
        // _______________________VIEW COMPILER START________________________________
        app.post('/studio/view/render', view_renderer.render);
        // _______________________VIEW COMPILER STOP_________________________________
        ...
        // _______________________STUDIO environments START__________________________//
        app.post('/studio/environments/:action', gate.studio, environments.api);
        // _______________________STUDIO environment variables STOP___________________________//

        // _______________________STUDIO environment variables START__________________________//
        app.post('/studio/environment_variables/:action', gate.studio, environment_variables.api);
        // _______________________STUDIO environment variables STOP___________________________//
    ...
    //______________________New APP START___________________________________//
    app.post('/application/login',jwtAuth.login);

    app.get('/app/:appname/apiRoute/*', jwtAuth.appGate, queries.executeApiRoute);
    app.post('/app/:appname/apiRoute/*', jwtAuth.appGate, queries.executeApiRoute);

    //______________________New APP END_____________________________________//
    ...
    if ( SETTINGS.studio ) {
        ...
        // :action = getAll
        app.get( '/api/gc_templates/:action',        /*gate.oAuthSimpleSigned,*/ api.gc_templates);
   ...
   // _________________________DEPLOYS STOP_______________________________________________________//
    ...
    // _______________________GC TEMPLATES START____________________________//
    if ( SETTINGS.studio ) {
        // :action = create, update, delete, deleteall, copy, copyall
        app.post('/studio/gctemplates/:action', gate.studio, gc_templates.api);
        app.get('/studio/gctemplates/list/:applicationName', gate.studio, gc_templates.getAll);
        app.get('/studio/gctemplates/list/:applicationName/:platform', gate.studio, gc_templates.getAllByPlatform);
        app.get('/studio/gctemplates/type/:gcTemplateType/:applicationName/:platform', gate.studio, gc_templates.getByType);
        app.get('/studio/gctemplates/:platform/:applicationName/:gcTemplateName/index.html', gate.studio, function (req, res) {gc_templates.index(req, res, version)});
        app.get('/studio/gctemplates/editui/:applicationName/:gcTemplateName/:platform', gate.studio, gc_templates.editui);
    }
    app.get('/studio/gctemplates/item/:gcTemplateName/:applicationName/:platform', gate.studio, gc_templates.select);
    app.get('/studio/gctemplates/item/:gcTemplateName/:applicationName/:platform/:tenant', gc_templates.select);
    // _______________________GC TEMPLATES STOP_____________________________//
};
