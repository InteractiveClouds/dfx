...
module.exports = {
    ...
    // the pathes to the directories:
    // MUST be set by user in local settings
    // MUST be an absolute pathes
    // MUST be outside of the project's directory
    // TODO change to one path as setting, and to create the dirs automatically inside it
    auth_conf_path             : '', // dev, dep
    tempDir                    : '', // dev
    tempDirForTemplates        : '', // dev
    app_build_path             : '', // dev
    resources_development_path : '', // dev
    fsdb_path                  : '', //      dep
    deploy_path                : '', //      dep
    public_dir_path            : '', // dev, dep

    api_so_response_max_size : 0,
    ...
    // For GitHub samples
    GitHub_samples : {
        accessToken : 'b30992d8e3d271fc073fee53fc111f6d1550d9ba',
        userName : 'InteractiveClouds',
        repoName : 'sampleapps',
        debug : false
    },
    // JWT Options
    JWT_SECRET : "DFX",
    TOKEN_EXPIRES_IN : 30 * 60 * 60 * 24
};