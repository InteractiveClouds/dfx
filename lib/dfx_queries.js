...
var api = {
    ...
    createCategory: function (parsed) {
        ...
        Query.createNewCat(parsed.queryParameters, parsed.req, function (err, data) {
            return err
                ? D.resolve(err)
                : D.resolve('The API Route category has been successfully created');
        });
        return D.promise;
    },
    ...
    updateCategory: function (parsed) {
        ...
        Query.setCat(parsed.name, parsed.queryParameters, parsed.req, function (err, data) {
            return err
                ? D.resolve(err)
                : D.resolve('The API Route category has been successfully updated');
        });
        return D.promise;
    },
    ...
    removeCategory: function (parsed) {
        ...
        Query.deleteCat(parsed.queryParameters, parsed.req, function () {
            return D.resolve('The API Route category ' + parsed.queryParameters.name + ' has been successfully deleted');
        });
        return D.promise;
    },
    ...
    createService: function (parsed) {
        ...
        Query.createNewService(parsed.queryParameters, parsed.req, function (err, data) {
            return err
                ? D.resolve(err)
                : D.resolve('The API Route service has been successfully created');
        });
        return D.promise;
    },
    ...
    updateService: function (parsed) {
        ...
        Query.setService(parsed.name, parsed.queryParameters, parsed.req, function (err, data) {
            return err
                ? D.resolve(err)
                : D.resolve('The API Route service has been successfully updated');
        });
        return D.promise;
    },
    ...
    removeService: function (parsed) {
        ...
        Query.deleteService(parsed.queryParameters.serviceName, parsed.req, function () {
            return D.resolve('The API Route service ' + parsed.queryParameters.serviceName + ' has been successfully deleted');
        });
        return D.promise;
    },
