...
Query.executeApiRoute = function (req, res) {
    ...
    var tenantid = ((req.method == 'POST') ?  req.body.tenantId : req.user.tenantid) || req.user.id,
        apiRoute = ((req.method == 'POST') ? req.body.url : req.query.url) || req.params[0],
        appName  = ((req.method == 'POST') ? req.body.appname : req.query.appname) || req.params['appname'],
