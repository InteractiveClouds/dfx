...
renderer.renderComponent = function(component_definition, parent_layout_column_orientation) {
   ...
   while ((m_static_attr = re_static.exec(nonv_attribute_template)) !== null) {
	...
	var gc_layout = getGcLayout(component_definition, parent_layout_column_orientation, attributes);
...
var getGcLayout = function (component_definition, parent_layout_column_orientation, attributes) {
    var gc_layout = '',
        props = {
            height: 'height:100%;',
