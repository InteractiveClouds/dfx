...
// SEARCH staffRoles\|staffRights\|rolesCache\|rightsCache
        ...
        function fillStaffCache () {
            ...
            console.log("Fill staffRights and staffRoles:");
            console.log("----------------------------------------------------------");
            console.log(staffRoles);
            console.log(staffRights);
            console.log("----------------------------------------------------------");
            return cache.Obj.set("staffRights", staffRights).then(function(){
                return cache.Obj.set("staffRoles", staffRoles);
            })
        }
        ...
        function fillCache () {
            ...
            return tenants.list()
                ...
                .then(function(){
                    ...
                    console.log("----------------------------------------------------------");
                    console.log(Object.keys(staffRoles));
                    console.log("----------------------------------------------------------");
                    console.log(Object.keys(staffRights));
                    console.log("----------------------------------------------------------");
                    console.log(Object.keys(rolesCache));
                    console.log("----------------------------------------------------------");
                    console.log(Object.keys(rightsCache));
                    console.log("----------------------------------------------------------");
        ...
        innerStorage.remove = function (roleName, tenantId, applicationName) {
            return Q.when( cacheIsReady, function () {
                ...
                console.log("remove and Set rolesCache:");
                console.log("----------------------------------------------------------");
        ...
        innerStorage.update = function ( w, roleName, tenantId, applicationName, userId ) {
            ...
            return Q.when( cacheIsReady, function(){
                ...
                console.log("Set update rolesCache:");
                console.log("----------------------------------------------------------");
                console.log(rolesCache);
                console.log("----------------------------------------------------------");
            ...
            return cache.Obj.get("rolesCache").then(function (rolesCache){
                ...
                return Q.when(cacheIsReady, function () {
                    ...
                    return cache.Obj.set("rolesCache", tenantId + '.' + appName + '.' + roleName + '.rights.right', true).then(function(){
                        ...
                        console.log("addRightToRole and set rolesCache:");
                        console.log("----------------------------------------------------------");
                        console.log(rolesCache);
                        console.log("----------------------------------------------------------");
        ...
        innerStorage.changeRightsName = function ( from, to, tenantId, applicationName ) {
            return cache.Obj.get("rightsCache").then(function(rightsCache) {
                return Q.when(cacheIsReady, function () {
                    ...
                    console.log("changeRightsName and set rightsCache:");
                    console.log("----------------------------------------------------------");
                    console.log(rightsCache);
                    console.log("----------------------------------------------------------");
                    return fillCache();
                });
            });
            ...
            return cache.Obj.get("rightsCache").then(function(rightsCache) {
                return cache.Obj.get("rolesCache").then(function (rolesCache) {
                    return Q.when(cacheIsReady, function () {
                        ...
                        console.log("removeRight and  set rolesCache and rightsCache:");
                        console.log("----------------------------------------------------------");
                        console.log(rolesCache);
                        console.log(rightsCache);
                        console.log("----------------------------------------------------------");
        ...
        innerStorage.addTenantToCache = function ( tenantId ) {
            rolesCache[tenantId] = {};
            rightsCache[tenantId] = {};
            console.log("Add tenant to cache and set rolesCache and rightsCache:");
            console.log("----------------------------------------------------------");
            console.log(rolesCache);
            console.log(rightsCache);
            console.log("----------------------------------------------------------");
